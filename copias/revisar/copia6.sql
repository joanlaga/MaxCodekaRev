...
) ENGINE=MyISAM AUTO_INCREMENT=91 DEFAULT CHARSET=utf8 COMMENT='Articulos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `artpro` VALUES ('13',18,4,'234.00'),('16',18,7,'114802.00'),('16',18,8,'12352.00'),('34',25,7,'0.54'),('42',40,12,'36.54'),('39',66,15,'14.32'),('42',40,17,'36.54'),('82',63,17,'95.00'),('50',69,20,'85.00'),('40',66,12,'5.00'),('83',61,13,'2.00'),('83',61,17,'4.00');
...
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='Clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Cobradores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cobradores` VALUES (1,'ernesto  perez ','1'),(2,'juan gacitua','0'),(4,'irene perez','0'),(5,'xccxcxc','1'),(6,'jbbbb','1'),(7,'vbxfzf','1'),(8,'asd','1');
...
INSERT INTO `cobros` VALUES (1,1,1,'192.42',1,'7896321456','2011-02-22',''),(2,3,1,'20.00',3,'1234','2011-02-28','primer pago'),(3,3,1,'35.68',7,'3456','2011-02-22','cheq'),(4,5,1,'82.47',6,'7896325621','2011-02-23',''),(5,10,16,'153.51',3,'','2011-02-23',''),(6,13,1,'59.50',1,'','2011-02-23',''),(7,4,18,'5.00',3,'','2011-02-25',''),(8,2007,17,'7.10',7,'896321','2011-02-26',''),(9,2000,1,'190.16',3,'33','2011-03-05',''),(10,2020,1,'29.75',1,'','2011-03-06',''),(11,2021,16,'20.00',3,'123','2011-03-06',''),(12,2021,16,'51.40',3,'456','2011-03-06',''),(13,2022,22,'55.10',3,'345','2011-03-06','cheque banco machala'),(14,2018,16,'50.00',3,'','2011-03-06','1er abono'),(15,2024,1,'76.76',3,'','2011-03-07',''),(16,2025,1,'59.50',3,'','2011-03-07',''),(17,2028,1,'938.91',1,'456321','2011-03-07',''),(18,2029,1,'146.37',6,'12364','2011-03-07',''),(19,2031,1,'29.75',3,'','2011-03-09',''),(20,2038,16,'938.91',1,'','2011-03-30','');
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Embalajes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `embalajes` VALUES (1,'Caja','0'),(2,'resma','0'),(3,'unidad','0'),(4,'No aplica','0'),(7,'Blister','0'),(8,'kilos','0'),(9,'m2','0');
...
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='Entidades Bancarias';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entidades` VALUES (12,'BANCO DE COMERCIO','0'),(13,'BANCO DE CREDITO ','0'),(15,'BANCO FINANCIERO','0'),(16,'BANCO INTERAMERICANO DE FINANZAS','0'),(17,'BANCO RIPLEY S.A.','0'),(19,'BBVA BANCO CONTINENTAL','0'),(22,'INTERBANK','0'),(23,'MIBANCO, BANCO DE LA MICROEMPRESA','0'),(25,'CITI','0'),(26,'asd','1');
...
INSERT INTO `factulineap` VALUES ('0002',17,1,61,'83','1.00','2.00','2.00',0),('0002',17,2,61,'83','4.00','4.00','16.00',0),('0003',17,1,61,'83','1.00','4.00','4.00',0),('0004',17,1,61,'83','2.00','4.00','8.00',0);
...
) ENGINE=MyISAM AUTO_INCREMENT=2048 DEFAULT CHARSET=utf8 COMMENT='facturas de ventas a clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturasp` VALUES ('0002',17,'2011-02-26',19,'2','21.42','0000-00-00','0'),('0003',17,'2011-02-26',19,'1','4.76','0000-00-00','0'),('0004',17,'2011-02-26',19,'1','9.52','2011-02-25','0');
...
CREATE TABLE `facturastmp` (
  ...
  `fecha` date NOT NULL,
  PRIMARY KEY (`codfactura`)
) ENGINE=MyISAM AUTO_INCREMENT=2229 DEFAULT CHARSET=utf8 COMMENT='temporal de facturas a clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `facturastmp` VALUES (2228,'2014-10-24'),(2227,'2014-10-24'),(2226,'2014-10-24');
...
) ENGINE=MyISAM AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='familia de articulos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `familias` VALUES (28,'ACCESORIOS DE NOTEBO','1'),(29,'ACCESORIOS PARA CASE','1'),(30,'CABLES DIVERSOS','1'),(31,'CARD READERS / WRITER','0'),(32,'CASES (GABINETES)','0'),(33,'COOLERS PARA MICROPROCESADORES','0'),(34,'DISCOS DUROS EXTERNO','0'),(35,'DISCOS DUROS INTERNO','0'),(36,'DISP. DE ALMACENAMIENTO','0'),(37,'DISP. DE IMAGENES','0'),(38,'DISP. OPTICOS DE L/E','0'),(39,'DISP. PARA REDES CAB','0'),(40,'DISP. PARA REDES WIF','0'),(41,'ESTABILIZADORES','0'),(42,'FUENTES DE PODER','0'),(43,'IMPRESORAS','0'),(44,'MAINBOARDS','0'),(45,'MEMORIAS','0'),(46,'MEMORIAS DIGITALES,U','0'),(47,'MICROPROCESADORES','1'),(48,'MICROPROCESADORES','0'),(49,'MONITORES','0'),(50,'MOUSE, TRACKBALL, PU','0'),(51,'NOTEBOOKS, LAPTOPS','0'),(52,'OTRAS TARJETAS CONTR','0'),(53,'PARLANTES / SUBWOOFER','0'),(54,'PCS DE MARCA','0'),(55,'PCS ENSAMBLADAS','0'),(56,'PRINT SERVER','0'),(57,'PRODUCTOS PARA VOIP','0'),(58,'REPUESTOS DE NOTEBOOK','0'),(59,'SERVIDORES','1'),(60,'SOFTWARE','0'),(61,'SUMINISTROS','0'),(62,'SUPERMULTI DVD & BLU','0'),(63,'TARJETAS DE VIDEO','0'),(64,'TECLADOS','0'),(65,'UPS Y DISP. DE PROTE','1'),(66,'COOLERS PARA CASES','0'),(67,'OTROS DISPOSITIVOS','0'),(69,'BATERIAS','0'),(70,'Aromatizantes','1'),(71,'RESISTENCIAS','0'),(72,'BASCULAS','0');
...
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Forma de pago';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `formapago` VALUES (1,'Tarjeta de cr','0'),(2,'Cr','0'),(3,'Contado/Efectivo','0'),(6,'Cheque al dia','0'),(7,'Cheque 30 dias','0'),(8,'Nota de Credito','0'),(9,'asd','1');
...
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='tipos de impuestos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `impuestos` VALUES (5,'IVA','19.0','0'),(7,'Exento','0.0','0'),(13,'asd','12.0','1');
...
CREATE TABLE `pagos` (
  ...
  `observaciones` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='Pagos de facturas a proveedores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pagos` VALUES (1,'2342',13,'256.00',2,'34567','2011-02-10','ret'),(2,'0002',17,'22.00',3,'2','2011-02-26','pago 22 pesos'),(3,'0004',17,'0.52',7,'896321','2011-02-26',''),(4,'0002',17,'0.58',6,'nc/1234','2011-02-26','seentrega nota de credito'),(5,'0002',17,'-1.16',6,'NC/2345','2011-02-26','se entrega nota credito 5643'),(6,'0002',17,'0.00',6,'','2011-02-26',''),(7,'0004',17,'8.00',8,'NC/7862','2011-02-26','nota credito 7851');
...
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='Proveedores';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='Provincias';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tabbackup` VALUES (1,'RP220220111755','2011-02-22','17:55:26','../copias/copia1.sql'),(2,'yioyukluilululu','2011-02-23','02:15:18','../copias/copia2.sql'),(3,'JJJ','2011-02-25','16:00:00','../copias/copia3.sql'),(4,'JAZMIN','2011-02-26','13:22:22','../copias/copia4.sql'),(5,'uuu','2011-02-26','13:23:51','../copias/copia5.sql');
...
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Ubicaciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ubicaciones` VALUES (3,'PV Robotec - Juan Cuglievan','0'),(5,'PV Robotec - Alfredo Lapoint','0'),(12,'a-1-1','1'),(13,'asd','1');
...
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='Clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `vendedores` VALUES (8,'Juan Espinoza ','','','0'),(10,'Maria Espinoza','','','0'),(11,'Carlos Jorquera','','','0');
...
-- Dump completed on 2014-10-25  0:57:58
