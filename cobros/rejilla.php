...
<html>
	...
	if ($filas > 0) { ?>
						...
						<tr class="<?php  echo $fondolinea?>">
							...
							<td width="5%"><div align="center"><a href="#"><img src="../images/dinero.jpg" width="16" height="16" border="0" onClick="ver_cobros(<?php  echo mysql_result($res_resultado,$contador,"codfactura")?>)" title="Ver Cobros"></a></div></td>
						</tr>
						<?php  $contador++;
							}
						?>			
