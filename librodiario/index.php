...
/****************PDF*********************************************/
	...
	<body onLoad="inicio()">
				...
				<form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
					  <tr>
					    ...
					    <td width="69%"><input id="fechainicio" type="text" class="cajaPequena" NAME="fechainicio" maxlength="10" value="<?php echo $fechainicio?>"><img src="../images/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" title="Calendario">
        <script type="text/javascript">
					Calendar.setup(
					  {
					...
					button     : "Image1"
						...
						<tr>
						  <td>Fecha de fin</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" NAME="fechafin" maxlength="10" value="<?php echo $fechafin?>"><img src="../images/calendario.png" name="Image2" id="Image2" width="16" height="16" border="0" title="Calendario2">
	   ...
	   <script type="text/javascript">
					...
					<div id="botonBusqueda"><img src="../images/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar();valFechas()" onMouseOver="style.cursor=cursor">
