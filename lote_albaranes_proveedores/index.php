...
@$cadena_busqueda=$_REQUEST["cadena_busqueda"];//jonaaga
				...
				<form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codproveedor" type="text" class="cajaPequena" NAME="codproveedor" maxlength="10"><img src="../images/ver.png" width="16" height="16" onClick="abreVentana()" title="Buscar proveedor"> <img src="../images/cliente.png" width="16" height="16" onClick="validarproveedor()" title="Validar proveedor"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
        ...
        <script type="text/javascript">
				...
				<img src="../images/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar()" onMouseOver="style.cursor=cursor">
			 	  <img src="../images/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../images/botonfacturaralbaranes.jpg" width="131" height="22" border="1" onClick="facturar_albaran()" onMouseOver="style.cursor=cursor">				
				</div>
