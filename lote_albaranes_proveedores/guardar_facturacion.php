...
$codfactura=$_REQUEST["Afactura"];
$totalfactura=$_REQUEST["totalfactura"];
$totalfacturasiniva=$_REQUEST["totalfacturasiniva"];
$iva=$_REQUEST["iva"];
$auxiva=$iva/100;
...
<html>
	...
	$rs_lineas=mysql_query($sel_lineas);
					...
					<div id="botonBusqueda">
					    ...
					    <img src="../images/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir('<?php echo $codfactura?>',<?php echo $codproveedor?>)" onMouseOver="style.cursor=cursor">
							</div>
						</div>
				  </div>
			  </div>
