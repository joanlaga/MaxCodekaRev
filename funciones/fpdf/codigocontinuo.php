...
print_r($barcode);# Fix 013803078411 Notice: Uninitialized string offset: 12 in /var/www/html/git/maxcodekarev/funciones/fpdf/codigocontinuo.php on line 52 FPDF error: Error codigo incorrecto
...
//       $barcode{"12"}=0;
	...
	for($i=0;$i<=10;$i+=2)
		$sum+=$barcode{$i};
	return ($sum+$barcode{"12"})%10==0;# Fix 013803078411 Notice: Uninitialized string offset: 12 in /var/www/html/git/maxcodekarev/funciones/fpdf/codigocontinuo.php on line 52 FPDF error: Error codigo incorrecto
}
