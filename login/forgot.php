...
";
	mail($_POST['email'], "Datos Solicitados a Facturaci�n PPER", $message,
    "From: \"Sistema de Facturaci�n\" <administrador@$host>\r\n" .
     "X-Mailer: PHP/" . phpversion());
	 
die("Gracias, su nueva Clave fu� enviada a su email");
