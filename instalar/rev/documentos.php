...
<?php  if ($ini=="1") {
include ("grabar_documentos.php"); ?>
  <?php  exit; } 
?>
</div>

<form name="form1" method="post" action="documentos.php" enctype="multipart/form-data">
...
<br>
<?php 
$dato=("A�adir Dise�o para Documentos");
...
?>
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="rayas">
	...
	<tr>
      <td class="barraazul">Nombre Albaranes:</td>
      <td><input name="albara" type="text" id="albara" size="10" maxlength="10" value="Albaran"></td>
    </tr>
	<tr>
