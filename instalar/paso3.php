<?php
//session_start();
include("../configuraciones/globales.php");
...
function sql_insert(){
  global $conn;
  global $_REQUEST;
  $sql = "INSERT INTO `maxcodekarev`.`parametros` (`indice` ,`usuario` ,`clave` ,`servidor` ,`basedatos` ,`numeracionfactura` ,`setnumfac` ,`fondofac` ,`imagenfac` ,`fondoguia` ,`imagenguia` ,`filasdetallefactura` ,`ivaimp` ,`nombremoneda` ,`simbolomoneda` ,`codigomoneda` ,`nomempresa` ,`giro` ,`fonos` ,`direccion` ,`comuna` ,`ciudadactual` ,`numerofiscal` ,`resolucionsii` ,`rutempresa` ,`giro2`)VALUES ('1', NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL , NULL);";
  mysql_query($sql, $conn) or die(mysql_error());
}
...
<td ><a href="paso3.php?a=edit&recid=<?php echo $i ?>"><b>Editar</b></a></td>
...
<tr>
<?php if ($page > 1) { ?>
<td><a href="paso3.php?page=<?php echo $page - 1 ?>">&lt;&lt;&nbsp;Prev</a>&nbsp;</td>
<?php } ?>
<?php
  global $pagerange;
...
<?php } else { ?>
<td><a href="paso3.php?page=<?php echo $j ?>"><?php echo $j ?></a></td>
<?php } } } else { ?>
<td><a href="paso3.php?page=<?php echo $startpage ?>"><?php echo $startpage ."..." .$count ?></a></td>
<?php } } } ?>
<?php if ($page < $pagecount) { ?>
<td>&nbsp;<a href="paso3.php?page=<?php echo $page + 1 ?>">Next&nbsp;&gt;&gt;</a>&nbsp;</td>
<?php } ?>
</tr>
</table>
<?php } ?>
...
<table class="fuente8" width="98%" cellspacing="1" border=0>
<tr align="right">
<td><a href="paso3.php"><img src="../images/botonvolver.png" width="69" height="22" border="1"></a></td>
<?php if ($recid > 0) { ?>
<td><a href="paso3.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>">Prior Record</a></td>
<?php } if ($recid < $count - 1) { ?>
<td><a href="paso3.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Next Record</a></td>
<?php } ?>
</tr>
</table>
</div>
