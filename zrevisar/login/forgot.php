...
$rs_search = mysql_query("select user_email from users where user_email='$_REQUEST[email]'");
...
mysql_query("UPDATE users set user_pwd='$newmd5pwd' where user_email='$_REQUEST[email]'");
$message = 
...
";
	mail($_REQUEST['email'], "Datos Solicitados a Facturación PPER", $message,
