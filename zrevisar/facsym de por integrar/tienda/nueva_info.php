...
<p><img src="../imagenes/mensajes/utilidadestienda.png" title="Administraci&oacute;n de Tienda"><br>
  ...
  <? if ($ini=="1") {
  if (empty($errores)) { include ("grabar_nueva_info.php"); ?>
  <? exit; } }
?>
</p>
<p>&nbsp;</p>
<form name="form1" method="post" action="nueva_info.php">
  <? print $errores; ?>
  ...
  <tr> 
   <td width="5px" height="23"> <a href="../principal.php"><img src="../imagenes/mensajes/botoniz.png" alt="Cerrar" border="0"></a></td>
    ...
    <td height="23" background="../imagenes/mensajes/top.gif"><div align="center" <font size="2">Informacion en Tienda</font>
  </div></td>
  ...
  <table width="93%" border="0" align="center" cellpadding="0" cellspacing="0" class="rayas">
    <tr>
      ...
      <? if ($ini=="0") { ?>
	  <td width="72%"><input name="uno" type="text" id="uno" size="50" maxlength="60"></td>
	  <? } else { ?>
      <td width="72%"><input name="uno" type="text" id="uno" size="50" maxlength="60" value="<? echo $uno; ?>"></td>
	  <? } ?>
    </tr>
    <tr>
      <td valign="top" class="barraazul"><strong>Observaciones:</strong></td>
	  <? if ($ini=="0") { ?>
      <td><textarea name="dos" cols="50" rows="5" id="dos"></textarea></td>
	  <? } else { ?>
      <td><textarea name="dos" cols="50" rows="5" id="dos"><? echo $dos; ?></textarea></td>
	  <? } ?>
    </tr>
    <tr>
	  <td class="barraazul"> <div align="justify" class="Estilo2">
	    <p align="left">Imagen </p>
	    </div></td>
	  <td>
