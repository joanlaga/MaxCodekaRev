...
<?php  if ($ini=="1") {
include ("grabar_modificar_docparte.php"); ?>
  <?php  exit; } 
?>
</div>

<form name="form1" method="post" action="modificar_docparte.php" enctype="multipart/form-data">

<?php  $consulta = "Select * from docparte";
...
if ($color=="") { 
$colo=azu;
$consulta = "INSERT INTO docparte (`color`) 
VALUES ('$colo')";
$resultado = mysql_query($consulta, $conexion);
}
...
?>
  <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="rayas">
	...
	<tr> 
      <td colspan="2" class="barraroja"><p>Textos En Parte:</p></td>
    </tr>
	<tr>
...
?>
		<div align="center"><br>
          <input type="submit" name="Submit" value="Modificar Dise�o de Parte">
