...
<?php  if ($ini=="1") {
include ("grabar_modificar_doclistado.php"); ?>
  <?php  exit; } 
?>
</div>

<form name="form1" method="post" action="modificar_doclistado.php" enctype="multipart/form-data">

<?php  $consulta = "Select * from doclistado";
...
if ($color=="") { 
$colo=azu;
$consulta = "INSERT INTO doclistado (`color`) 
VALUES ('$colo')";
$resultado = mysql_query($consulta, $conexion);
}
?>
...
<br>
<?php 
$dato=("Modificar Dise�o Listados");
 include ("../funciones/efectos/cuadroalto.php");
?>
<table width="85%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#333333" class="rayas">
    <tr> 
	 <td width="18%" class="barraazul">Color Listado:</td>
	...
	<tr class="barraazul"> 
      <td colspan="2" class="barraroja"><p>Pie en Listados :</p></td>
    </tr>
	<tr>
      <td class="barraazul">Condiciones:</td>
      <td><input name="condiciones" type="text" id="condiciones" size="80" maxlength="190" value="<?php  echo $lafila["condiciones"]; ?>"></td>
    </tr>
	<tr>
      <td class="barraazul"> Fuente:</td>
	...
	<tr>
      <td class="barraazul">Tama&ntilde;o Fuente:</td>
...
?>
	  	<div align="center"><br>
          <input type="submit" name="Submit" value="Modificar Dise�o de Listados">
