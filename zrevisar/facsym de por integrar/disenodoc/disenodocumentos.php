...
<?php  
   ...
   if ($filas<>0)
     {
?>
     <div align="center">  Dise�o de <?php  echo $lafila["albaran"]; ?> </div>
<table width="85%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666" class="metal">
<tr> 
...
<table width="85%" border="1" align="center">
  <tr>
    <td><div align="center"><font color="#FF0000">No existen Dise�o de Albaran en la Base de Datos. Por favor introduzcalos para que los documentos que 
        genere la aplicaci&oacute;n est&eacute;n configurados correctamente.</font><br>
        <br>
