...
function sale(){
	...
	<body>
		<div id="pagina">
				...
				<a href="../central2.php"><img src="../images/botonaceptar.jpg" alt="Salir" width="69" height="25" border="1" onclick = "../central2.php" onDblClick="../central2.php" title="salir"   /></a></div>			
