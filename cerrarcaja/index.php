...
<html>
	...
	<body onLoad="inicio()">
        ...
        <script type="text/javascript">
			 	...
			 	<div id="botonBusquedaBC"><img src="../images/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar()" onMouseOver="style.cursor=cursor"></div>
