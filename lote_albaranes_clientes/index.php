				...
				<form id="formulario" name="formulario" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codcliente" type="text" class="cajaPequena" NAME="codcliente" maxlength="10"><img src="../images/ver.png" width="16" height="16" onClick="abreVentana()" title="Buscar cliente"> <img src="../images/cliente.png" width="16" height="16" onClick="validarcliente()" title="Validar cliente"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
