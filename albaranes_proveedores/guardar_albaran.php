...
if ($accion=="convertir") {
	...
	$codfactura=$_REQUEST["Acodfactura"];
	$fecha=explota($fecha);
			  ...
			  <?php  if ($accion=="baja") { 
				...
				<div id="botonBusqueda">
					<div align="center">
					  ...
					  <?php  if ($accion<>"baja") { ?>
						   <?php  if ($accion=="convertir") { ?>
						   <img src="../images/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimirf('<?php  echo $codfactura?>',<?php  echo $codproveedor ?>)" onMouseOver="style.cursor=cursor">
						   <?php  } else { ?>
						   <img src="../images/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir('<?php  echo $codalbaran?>',<?php  echo $codproveedor ?>)" onMouseOver="style.cursor=cursor">
						   <?php  } ?>
				 <?php  } ?>
				        </div>
					</div>
