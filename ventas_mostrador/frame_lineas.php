...
//@$modif=$_REQUEST["modif"];//nuca es mandado

//	if ($modif<>1) {//nuca es mandado
...
//	$baseimp=$importe;//test
	...
	if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; } ?>
			...
			<tr class="<?php  echo $fondolinea?>">
				...
				<td width="2%"><a href="javascript:eliminar_linea(<?php  echo $codfacturatmp?>,<?php  echo $numlinea?>,<?php  echo $importe ?>)"><img src="../images/eliminar.png" border="0"></a></td>
			</tr>
<?php  } 
