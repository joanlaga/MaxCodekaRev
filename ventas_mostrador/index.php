		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
						<tr>
					      ...
					      <td colspan="3"><input NAME="codcliente" type="text" class="cajaPequena" id="codcliente" size="6" maxlength="5" onClick="limpiarcaja()">
					        <img src="../images/ver.png" width="16" height="16" onClick="abreVentana()" title="Buscar cliente" onMouseOver="style.cursor=cursor"> <img src="../images/cliente.png" width="16" height="16" onClick="validarcliente()" title="Validar cliente" onMouseOver="style.cursor=cursor"></td>					
						</tr>
						<tr>
					...
					<tr>
							<td width="6%">Fecha</td>
						    <td width="27%"><input NAME="fecha" type="text" class="cajaPequena" id="fecha" size="10" maxlength="10" value="<?php  echo $hoy?>" readonly> <img src="../images/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0"  onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fecha",
			  ...
			  <div id="frmBusquedaVTASM">
				...
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
				  <tr>
					...
					<td colspan="10" valign="middle"><input NAME="codbarras" type="text" class="cajaMedia" id="codbarras" size="15" maxlength="15"> <img src="../images/calculadora.jpg" border="1" align="absmiddle" onClick="validarArticulo()" onMouseOver="style.cursor=cursor" title="Validar codigo de barras">     <img src="../images/ver.png" width="16" height="16" onClick="ventanaArticulos()" onMouseOver="style.cursor=cursor" title="Buscar articulo"></td>
				  </tr>
				  <tr>
					<td>Descripcion</td>
				    ...
				    <td width="15%"><img src="../images/botonagregar.jpg" border="1" onClick="validar()" onMouseOver="style.cursor=cursor"></td>
				  </tr>
				</table>
				</div>
				<br>
