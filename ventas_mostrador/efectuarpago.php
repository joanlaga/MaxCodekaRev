...
<form id="formulario" name="formulario" method="post" action="guardar_cobro.php" target="frame_datos">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=2 border=0>
						...
						<tr>
							<td>Importe vale</td>
						    <td><?php  echo $codigomonedate?> <input NAME="importevale" type="text" class="cajaPequena" id="importevale" size="10" maxlength="10" value="0"> <img src="../images/disco.png" name="Image2" width="16" height="16" border="0" id="Image2" onMouseOver="this.style.cursor='pointer'" title="Aplicar Vale" onClick="actualizarimporte()"></td>
			            </tr>
						<tr>
							<td>A pagar</td>
						...
						<tr>
							<td>Pagado</td>
						    <td><?php  echo $codigomonedate?> <input NAME="pagado" type="text" class="cajaPequena" id="pagado" size="10" maxlength="10"> <img src="../images/dinero.jpg" name="Image2" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Pagado" onClick="actualizarimportedevolver()"></td>
			            </tr>
						<tr>
							<td>A devolver</td>
						...
						<tr>
						    ...
						    <td><input NAME="fechacobro" type="text" class="cajaPequena" id="fechacobro" size="10" maxlength="10" value="<?php  echo $hoy?>" readonly> <img src="../images/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					Calendar.setup(
					  {
			  ...
			  <br><br>
			  <div align="center">
					<img src="../images/botonaceptar.jpg" width="85" height="22" onClick="javascript:enviar(); mostrar_img()"  border="1" onMouseOver="style.cursor=cursor">
					<img src="../images/botonimprimirticket.jpg" width="122" height="22" onClick="imprimir(<?php  echo $codfactura?>)" border="1" onMouseOver="style.cursor=cursor" id="img" style = "visibility:hidden">
					<img src="../images/botoncancelar.jpg" width="85" height="22" onClick="window.close()" border="1" onMouseOver="style.cursor=cursor">
			  </div>
