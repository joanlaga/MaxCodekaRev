...
$localidad=$_REQUEST["alocalidad"];
$codprovincia=$_REQUEST["cboProvincias"];
$codformapago=$_REQUEST["cboFPago"];
$codentidad=$_REQUEST["cboBanco"];
$cuentabanco=$_REQUEST["acuentabanco"];
$codpostal=$_REQUEST["acodpostal"];
$telefono=$_REQUEST["atelefono"];
$movil=$_REQUEST["amovil"];
