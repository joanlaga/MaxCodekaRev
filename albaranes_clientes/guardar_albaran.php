				...
				<div id="botonBusqueda">
					<div align="center">
					 <img src="../images/botonaceptar.jpg" width="85" height="22" onClick="aceptar()" border="1" onMouseOver="style.cursor=cursor">
					  <?php if ($accion=="convertir") { ?>
					   <img src="../images/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimirf(<?php echo $codfactura?>)" onMouseOver="style.cursor=cursor">
					   <?php } else { ?>
					   <img src="../images/botonimprimir.jpg" width="79" height="22" border="1" onClick="imprimir(<?php echo $codalbaran?>)" onMouseOver="style.cursor=cursor">
					   <?php } ?>
				        </div>
					</div>
			  </div>
