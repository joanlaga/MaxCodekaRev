...
.error_strings{ font-family:Verdana; font-size:14px; color:#660000; background-color:#ff0;}
	...
	<script type="text/javascript" language="JavaScript" src="../funciones/gen_validatorv4.js"     xml:space="preserve"></script>
...
.error_strings{ font-family:Verdana; font-size:14px; color:#660000; background-color:#ff0;}
	...
	<script type="text/javascript" language="JavaScript" src="gen_validatorv4.js"    xml:space="preserve"></script>
