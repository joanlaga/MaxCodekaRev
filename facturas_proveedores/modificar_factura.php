			  ...
			  <div id="frmBusqueda">
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  <tr>
					...
					<td colspan="10"><input NAME="referencia" type="text" class="cajaMedia" id="referencia" size="15" maxlength="15" readonly> <img src="../images/ver.png" width="16" height="16" onClick="ventanaArticulos()" title="Buscar articulos"></td>
				  </tr>
				  <tr>
					<td>Descripcion</td>
