	...
	<body onLoad="inicio()">
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
						...
						<tr>
						  <td>Fecha de fin</td>
						  <td><input id="fechafin" type="text" class="cajaPequena" NAME="fechafin" maxlength="10" value="<?php echo $fechafin?>" readonly><img src="../images/calendario.png" name="Image1" id="Image2" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'" title="Calendario2">
        <script type="text/javascript">
					Calendar.setup(
					  {
					inputField : "fechafin",
			 	...
			 	<div id="botonBusqueda">
			 	  ...
			 	  <img src="../images/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../images/botonnuevafactura.jpg" width="106" height="22" border="1" onClick="nueva_factura()" onMouseOver="style.cursor=cursor">				
				</div>
