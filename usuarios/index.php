...
include ("../configuraciones/conectar.php");
	...
	if(!isset($_REQUEST["cadena_busqueda"])){ 
		...
		$cadena_busqueda = str_replace("",",",$_REQUEST["cadena_busqueda"]);
	}
...
<html>
	<head>
		<title>CodeKaRev, Vendedores</title>
			...
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
			 	...
			 	<div id="botonBusqueda">
					...
					<img src="../images/botonnuevovendedor.jpg" width="125" height="22" border="1" onClick="nueva_entidad()" onMouseOver="style.cursor=cursor">
